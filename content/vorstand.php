...
<p><font style="float: right;"size="-1">Stand: <?php
	$monthen = date("n");
	$monat = getGermanMonth($monthen);
echo $monat." ".date("Y"); ?></font></p>
<table class="vorstand" width="100%">
<tr>
<td width="229px">
...
<td width="229px"><b>Pr&auml;sident</b><br>
Hanspeter Moll<br>
